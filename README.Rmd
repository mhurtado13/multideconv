...
These are basic examples which shows you how to use `multideconv` for different tasks. For a detailed tutorial, see the  [tutorial](https://mhurtado13.github.io/multideconv/index.html) 

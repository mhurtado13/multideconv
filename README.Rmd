...
These are basic examples which shows you how to use `multideconv` for different tasks. For a detailed tutorial, see [Get started](https://mhurtado13.github.io/multideconv/articles/multideconv.html)
